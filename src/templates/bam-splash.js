...
const BamSplashTemplate = () => {
  ...
  useEffect(() => {
    if (!prevSplash) {
        document.querySelector('#container.bam-splash').style.backgroundImage = `url(${splash})`
    }
  }, [ prevSplash, splash ]);  
  ...
  return (
    <div style={ { position: "relative", zIndex: "100", display: "flex", justifyContent: "center" } }>
      <a href="/animation/#bam">
        <img src="https://res.cloudinary.com/dunew51zn/image/upload/v1617059120/bam/button-240_yr76p9.jpg" alt="BAM. Click here to watch movie (5 minutes)" />
      </a>
    </div>
)}
