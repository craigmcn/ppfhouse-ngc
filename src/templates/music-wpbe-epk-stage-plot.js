...
const WpbeEpkStagePlotPage = ({ data }) => {
  ...
  return (
    <Layout className="music wpbe has-sidebar no-columns" pageHeader={ PageHeader } sidebar={ Sidebar }>
      ...
      <p class="wpbe-cta">
        <a href="http://cdn.ppfhouse.com/wpbe/wpbe-epk.2018.pdf" target="_blank" rel="noreferrer">Electronic press kit (EPK)</a>
      </p>
      ...
      <p>
        <a
          ...
          onClick={ handleClick }
        >
          <img src="https://res.cloudinary.com/dunew51zn/image/upload/v1617059321/music/wpbe-stage-plot-t_o3f52l.jpg" alt="WPBE stage plot" />
        </a>
      </p>

      <Modal handleClose={() => setOpen(false)} isOpen={open} className="lightbox">
        <img src="https://res.cloudinary.com/dunew51zn/image/upload/v1617059321/music/wpbe-stage-plot_cvxvjb.jpg" alt="WPBE stage plot" />
      </Modal>
    </Layout>
  )
}
